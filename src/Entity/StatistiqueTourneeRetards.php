...
use App\Repository\StatistiqueTourneeRetardsRepository;
use Doctrine\ORM\Mapping as ORM;
use ApiPlatform\Core\Annotation\ApiResource;

/**
 * @ApiResource
 * @ORM\Entity(repositoryClass=StatistiqueTourneeRetardsRepository::class)
 */
class StatistiqueTourneeRetards
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
