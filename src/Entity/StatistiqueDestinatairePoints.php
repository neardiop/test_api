...
use App\Repository\StatistiqueDestinatairePointsRepository;
use Doctrine\ORM\Mapping as ORM;
use ApiPlatform\Core\Annotation\ApiResource;

/**
 * @ApiResource
 * @ORM\Entity(repositoryClass=StatistiqueDestinatairePointsRepository::class)
 */
class StatistiqueDestinatairePoints
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
