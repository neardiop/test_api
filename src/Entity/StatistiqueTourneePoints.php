...
use App\Repository\StatistiqueTourneePointsRepository;
 ...
 * @ORM\Entity(repositoryClass=StatistiqueTourneePointsRepository::class)
 */
class StatistiqueTourneePoints
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
