...
use App\Repository\StatistiqueClientRepository;
 ...
 * @ORM\Entity(repositoryClass=StatistiqueClientRepository::class)
 */
class StatistiqueClient
{
     ...
     * @ORM\Column(type="integer")
     */
    private $nombre_colis_livres_hors_delais;
    ...
    public function getNombreColisLivresHorsDelais(): ?int
    {
        return $this->nombre_colis_livres_hors_delais;
    }

    public function setNombreColisLivresHorsDelais(int $nombre_colis_livres_hors_delais): self
    {
        $this->nombre_colis_livres_hors_delais = $nombre_colis_livres_hors_delais;
