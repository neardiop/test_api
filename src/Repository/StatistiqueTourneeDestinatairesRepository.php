...
/**
 * @method StatistiqueTourneeDestinataires|null find($id, $lockMode = null, $lockVersion = null)
 * @method StatistiqueTourneeDestinataires|null findOneBy(array $criteria, array $orderBy = null)
 * @method StatistiqueTourneeDestinataires[]    findAll()
 * @method StatistiqueTourneeDestinataires[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class StatistiqueTourneeDestinatairesRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, StatistiqueTourneeDestinataires::class);
    }
    ...
    public function getAll(RequestStack $requestStack)
    {
        ...
        nom AS nom
    FROM
        statistiques.statistique_tournee_destinataires s0_
            INNER JOIN
        statistiques.clients c1_ ON s0_.clients_id = c1_.id
            INNER JOIN
        cogepart.clients_adresses c2_ ON s0_.clients_adresses_id = c2_.id
            INNER JOIN
	    new_cogepart.client_tournee c3_ ON s0_.numero_tournee_id = c3_.id
    WHERE
        c1_.client_id = $idclient
        AND c3_.libelle = '$num_tournee'
        ", $rsm);
